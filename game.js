...
var requestAnimFrame = (function (el) {
...
//начальные установки
function init() {
	canvas.addEventListener("mousemove" || "click", function (event) {
		...
		var scrollX = event.clientX - rect.left - root.scrollLeft;
		var scrollY = event.clientY - rect.top - root.scrollTop;
		...
		ship.x = scrollX * 600 / width_canvas - 25;
		ship.y = scrollY * 600 / height_canvas - 13;
	});
